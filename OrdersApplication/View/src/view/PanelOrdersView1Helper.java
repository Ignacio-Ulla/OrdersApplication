...
public class PanelOrdersView1Helper extends JPanel implements JUPanel {
    ...
    private JUPanelBinding panelBinding =
        new JUPanelBinding("view_PanelOrdersView1HelperPageDef");
    private JPanel dataPanel = new JPanel();
    private BorderLayout borderLayout = new BorderLayout();

    private FormLayout panelLayout =
        new FormLayout("f:3dlu:n, f:d:g, f:3dlu:n, f:d:n, f:3dlu:n", "c:3dlu:n, c:d:n, c:3dlu:n, c:d:n, c:3dlu:n, c:d:n, c:3dlu:n, c:d:n, c:3dlu:n");
    ...
    public void jbInit() throws Exception {
        ...
        dataPanel.add(labelmOrderId,
                      new CellConstraints("2 , 2 ,1,1,default," +
                                          CellConstraints.FILL));
        dataPanel.add(mOrderId,
                      new CellConstraints("4, 2 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(labelmOrderDate,
                      new CellConstraints("2 , 4 ,1,1,default," +
                                          CellConstraints.FILL));
        dataPanel.add(mOrderDate,
                      new CellConstraints("4, 4 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(labelmOrderStatusCode,
                      new CellConstraints("2 , 6 ,1,1,default," +
                                          CellConstraints.FILL));
        dataPanel.add(mOrderStatusCode,
                      new CellConstraints("4, 6 ,1,1,default," +
                                          CellConstraints.FILL));
        dataPanel.add(labelmOrderTotal,
                      new CellConstraints("2 , 8 ,1,1,default," +
                                          CellConstraints.FILL));
        dataPanel.add(mOrderTotal,
                      new CellConstraints("4, 8 ,1,1,default," + CellConstraints.FILL));

        labelmOrderId.setLabelFor(mOrderId);
        labelmOrderId.setText("<html><B>" +
                              panelBinding.findCtrlValueBinding("OrderId").getLabel() +
                              "</B></html>");
        ...
        labelmOrderDate.setText("<html><B>" +
                                panelBinding.findCtrlValueBinding("OrderDate").getLabel() +
                                "</B></html>");
        ...
        labelmOrderStatusCode.setText("<html><B>" +
                                      panelBinding.findCtrlValueBinding("OrderStatusCode").getLabel() +
                                      "</B></html>");
        ...
        labelmOrderTotal.setText("<html><B>" +
                                 panelBinding.findCtrlValueBinding("OrderTotal").getLabel() +
                                 "</B></html>");
        ...
        mOrderId.setDocument((Document)panelBinding.bindUIControl("OrderId",
                                                                  mOrderId));
        mOrderDate.setToolTipText((panelBinding.findCtrlValueBinding("OrderDate")).getTooltip());
        mOrderDate.setColumns(panelBinding.findCtrlValueBinding("OrderDate").getDisplayWidth());
        mOrderDate.setDocument((Document)panelBinding.bindUIControl("OrderDate",
                                                                    mOrderDate));
        mOrderStatusCode.setToolTipText((panelBinding.findCtrlValueBinding("OrderStatusCode")).getTooltip());
        mOrderStatusCode.setColumns(panelBinding.findCtrlValueBinding("OrderStatusCode").getDisplayWidth());
        mOrderStatusCode.setDocument((Document)panelBinding.bindUIControl("OrderStatusCode",
                                                                          mOrderStatusCode));
        mOrderTotal.setToolTipText((panelBinding.findCtrlValueBinding("OrderTotal")).getTooltip());
        mOrderTotal.setColumns(panelBinding.findCtrlValueBinding("OrderTotal").getDisplayWidth());
        mOrderTotal.setDocument((Document)panelBinding.bindUIControl("OrderTotal",
                                                                     mOrderTotal));
    ...
    public static void main(String[] args) {
        ...
        panel.setBindingContext(JUTestFrame.startTestFrame("view.DataBindings.cpx",
                                                           "null", panel,
