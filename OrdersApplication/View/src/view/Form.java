...
public class Form extends JFrame {
    ...
    private JUPanelBinding panelBinding =
        new JUPanelBinding("view_FormPageDef");
    ...
    private PanelOrdersView1Helper panelOrdersView1Helper1 =
        new PanelOrdersView1Helper();
    private BorderLayout borderLayout1 = new BorderLayout();
    private OrderItemsPanel orderItemsPanel1 = new OrderItemsPanel();
    ...
    public void jbInit() throws Exception {
        orderItemsPanel1.bindNestedContainer(panelBinding.findNestedPanelBinding("view_OrderItemsPanelPageDef"));
        panelOrdersView1Helper1.bindNestedContainer(panelBinding.findNestedPanelBinding("view_PanelOrdersView1HelperPageDef"));
        ...
        dataPanel.add(panelOrdersView1Helper1, BorderLayout.NORTH);
        dataPanel.add(orderItemsPanel1, BorderLayout.CENTER);
        ...
        hiddenNavBar.setModel(JUNavigationBar.createPanelBinding(panelBinding,
                                                                 hiddenNavBar));
        navBar.setModel(JUNavigationBar.createPanelBinding(panelBinding,
                                                           navBar));
        statusBar.setModel(JUStatusBar.createPanelBinding(panelBinding,
                                                          statusBar));
    }
    ...
    private int _popupTransactionDialog() {
        ...
        if (panelBinding.isTransactionDirty()) {
            ...
            final JOptionPane optionPane =
                new JOptionPane("How do you want to close the transaction?",
            ...
            optionPane.createDialog(Form.this,
                                    "Transaction open").setVisible(true);
